...
const io = socketIo(server, {
  cors: {
    origin: 'https://reivun.vercel.app',  // Allow frontend domain for WebSocket
    methods: ['GET', 'POST'],
  },
});

app.use(cors({ origin: 'https://reivun.vercel.app' }));  // Allow frontend domain for HTTP requests
...
// Start server
server.listen(5000, () => {
  console.log('Server running at https://reivun-gkdi.vercel.app');
});
